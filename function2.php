...
$maxRows_EmployeeRecordset = 10;
$pageNum_EmployeeRecordset = 0;
if (isset($_GET['pageNum_EmployeeRecordset'])) {
  $pageNum_EmployeeRecordset = $_GET['pageNum_EmployeeRecordset'];
}
$startRow_EmployeeRecordset = $pageNum_EmployeeRecordset * $maxRows_EmployeeRecordset;

mysql_select_db($database_remotesql, $remotesql);
$query_EmployeeRecordset = "SELECT * FROM EMPLOYEE";
$query_limit_EmployeeRecordset = sprintf("%s LIMIT %d, %d", $query_EmployeeRecordset, $startRow_EmployeeRecordset, $maxRows_EmployeeRecordset);
$EmployeeRecordset = mysql_query($query_limit_EmployeeRecordset, $remotesql) or die(mysql_error());
$row_EmployeeRecordset = mysql_fetch_assoc($EmployeeRecordset);
?>
<!DOCTYPE html>
<html>
...
?>
            ...
            <div class="content"><h2>Add New Project</h2>
          ...
          <?php do { ?>
            <option value="<?php echo $row_EmployeeRecordset['EmployeeID']; ?>"><?php echo $row_EmployeeRecordset['EmployeeName']; ?></option>
          <?php } while ($row_EmployeeRecordset = mysql_fetch_assoc($EmployeeRecordset)); ?>
	        </select>
